...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_map_ogmo extends null { }
...
@:keep @:file("assets/map.ogmo") @:noCompletion #if display private #end class __ASSET__assets_map_ogmo extends haxe.io.Bytes {}
